  ...
  <div class="min-h-screen p-4 bg-ctp-crust text-ctp-teal">
    ...
    <div v-else class="p-20 flex items-center justify-center">
      <div class="relative inline-flex  group ">
        ...
        <a href="#" title="back" class="relative inline-flex items-center justify-center px-8 py-4 text-lg font-bold 
          text-ctp-text text-xl transition-all duration-200 bg-ctp-base rounded-md focus:outline-none 
          focus:ring-2 focus:ring-offset-2 focus:ring-gray-900" role="button"><i
            class="fa-solid fa-angles-left"></i>BACK
        </a>
      </div>
    </div>
