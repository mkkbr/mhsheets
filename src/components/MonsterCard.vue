  ...
  <div className="flex flex-col justify-evenly md:flex-row">
    ...
    <div className="flex flex-col p-2">
      ...
      <div className="flex justify-center p-2 gap-4">
        ...
        <div class="flex flex-col min-w-30">
          <div v-for="(value, element) in monster.elements" :key="element" class="flex items-center">
            <img v-if="best(value, monster.elements) != 0" :src="`./images/icons/${element}.png`" :alt="element" class="w-9 mr-2 p-1 drop-shadow-[0_0px_6px_rgba(249,226,175,1)]" />
        ...
        <div class="flex flex-col min-w-30">
          <div v-for="(value, status) in monster.status" :key="status" class="flex items-center">
            ...
            <div class="flex">
              ...
              <span v-for="star in stars(value, 'status')" :key="star" class="text-base text-ctp-yellow-800"><i class="fa-solid fa-star"></i></span>
            </div>
          </div>
        </div>
      </div>
      <div class="gap-4 flex justify-center p-2 text-sm items-center">
        ...
        <img src="/images/icons/kinsect.png" alt="kinsect" title="kinsect" class="w-7 mr-4" />{{ monster.kinsect.red}}</span>
